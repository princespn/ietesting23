...
class Ajax_Model extends MY_Model {
    ...
    public function get_student_list($class_id, $school_id, $academic_year_id){
        $this->db->select('E.roll_no,  S.id, S.user_id, S.name,S.admission_no');
    ...
    public function get_ledger_list($school_id,$onlyassets =null,$financial_year_id =null){
        $this->db->select('AL.*,AG.name as group_name,AG.base_id');
