...
$config['base_url'] =  'http://localhost/ietesting23';

// example
// $config['base_url'] =  'http://www.vbrajasthan.in';
...
define('SMS', 'VBRNet');
define('FROM_EMAIL', 'info@FALSEwqrqrq.com');
define('FROM_NAME', 'VBRNet');
