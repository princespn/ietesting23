...
class Finalresult_Model extends MY_Model {
    ...
    public function get_scheduled_subjects($school_id , $class_id , $academic_year_id,  $section_id = null)
    {
    ...
    public function get_student_list_with_result($school_id = null, $class_id = null, $section_id = null, $academic_year_id = null,$student_id = null){
        
    $this->db->select('M.*,EX.title as exam_name,S.name,S.admission_no, S.father_name,S.photo, E.roll_no, E.class_id, E.section_id, C.name AS class_name, AY.session_year,SB.name as subject_name');
        ...
        $this->db->where('E.school_id', $school_id);       
        $this->db->where('EX.academic_year_id', $academic_year_id);       
        $this->db->where('E.academic_year_id', $academic_year_id);       
        if($section_id){
            $this->db->where('E.section_id', $section_id);
        } 
