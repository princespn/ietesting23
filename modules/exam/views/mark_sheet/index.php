    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">             
                            <?php if(isset($school)){ ?>
                                <div class="float-container">
                                    ...
                                    <div class="float-child" style="width:35%">
                                        <?php if($school->logo){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->logo; ?>" alt="" style="height:100px; width:105px;"/> 
                                        <?php }else if($school->frontend_logo){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->frontend_logo; ?>" alt="" style="height:100px; width:105px;" /> 
                                        <?php }else{ ?>                                                        
                                            <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $this->global_setting->brand_logo; ?>" alt="" style="height:100px; width:105px;"  />
                                        <?php } ?>
                                    </div>
                                    
                                    <div class="float-child" style="width:60%;padding-left: 35px;">
                                        <div style="float:left;text-align:center">
                                        <h3> <?php echo $school->school_name; ?></h3>
                                        <?php echo $school->address; ?><br>
                                        <h5><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('mark_sheet'); ?> <?php echo substr($academic_year->start_year ,-4)?> - <?php echo substr($academic_year->end_year,-4) ?></h5>
                                        </div>
                                    </div>
                                    <div class="float-child" style="width:70%;text-align:left;padding-left:50px;    margin-top: 20px;">
                                        <b>Student's <?php echo $this->lang->line('name'); ?> : <?php echo $student->name; ?><br/>
                                        Father's <?php echo $this->lang->line('name'); ?> : <?php echo $student->father_name; ?><br/>
                                        Date of Birth : <?php echo $student->dob; ?></b>
                                    </div>
                                    <div class="float-child" style="width:30%;text-align:left;margin-top: 20px;">
            ...
            <div class="x_content">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="margin-bottom:0px" cellspacing="0" width="100%">
                   <thead>
                        <tr>
                            <th rowspan="2">Subject</th>
                            <?php foreach($exams_n as $exam){ ?>
                                <th colspan="2"><?php echo $exam ?></th>
                            <?php } ?>    
                            <th colspan="2">Grand</th>                                    
                        </tr>
                        <tr>          
                        ...
                        if (isset($reports) && !empty($reports)) {
                            ?>
                                ...
                                foreach($reports as $student_report){ 
                                    ...
                                    if($student_report->student_id != $student->id)
                                    {
                                        continue;
                                    }
                                    $istudent_found =1;
                                     $marks    = $student_report->subjects;
                                     $iTotalRowMax = [];
                                     $iTotalRowObtain = [];
                                    ...
                                    <?php foreach($subjects as $subject_id => $subject_name){ 
                                        ...
                                        <?php foreach($exams_n as $exam_id_n => $exam_name){ 
                                            $student_exam = $marks[$subject_id][$exam_id_n]  ?? '';
                                            if($student_exam)
                                            {
                                                if(!isset($iTotalRowMax[$exam_id_n])) $iTotalRowMax[$exam_id_n] = 0;
                                                if(!isset($iTotalRowObtain[$exam_id_n])) $iTotalRowObtain[$exam_id_n] = 0;
                                                $iTotalRowMax[$exam_id_n] = $iTotalRowMax[$exam_id_n] + $student_exam->written_mark;
                                                $iTotalRowObtain[$exam_id_n] =  $iTotalRowObtain[$exam_id_n] + $student_exam->written_obtain;
                                                $iTotalObtain =  $iTotalObtain + $student_exam->written_obtain;
                                                $iTotalMark = $iTotalMark + $student_exam->written_mark;
                                            }
                                            ?>
                                           <td><?php echo  $student_exam ? $student_exam->written_mark  : 0; ?> </td>
                                            <td><?php echo  $student_exam ?  $student_exam->written_obtain : 0; ?> </td>
                                    <?php } ?>
                            ...
                            <?php foreach($exams_n as $exam_id_n => $exam){ ?>
                                <td ><?php echo  $iTotalRowMax[$exam_id_n] ?? 0  ?></td>     
                                <td ><?php echo  $iTotalRowObtain[$exam_id_n] ?? 0 ?></td>  
                            <?php } ?>    
                ...
                <div class="float-container" style="background : unset !important">
                    ...
                    <?php
                    $percentage = $iGrandRowMax ? number_format( ($iGrandRowObtain /$iGrandRowMax)*100,2 ) : 0;
                    ?>
                    ...
                    {
                        $result  = $lowest_grade->mark_from >=  $percentage ? "Passed" : "Failed" ;
                    }
                    if($grade) 
                    {
                        $grade  = $grade->name ;
            ...
            <!-- /.col --> <b> &nbsp;&nbsp;HEAD MASTER <br><br> ________________ </b></div>
